    ...
    return (
        <Section>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-10 mt-8'>
                <div className='option bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105'>
                    <Image src='/path/to/graphic1.png' alt='Human Engagement' width={500} height={300} className='rounded-md mb-4' />
                    <h2 className='text-2xl font-bold'>Option 1: Human Engagement</h2>
                    <p className='mt-2 text-gray-700'>Negotiate a series of paid consultations which could cost between $500 and $3,000.</p>
                </div>
                <div className='option bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105'>
                    <Image src='/path/to/graphic2.png' alt='AI-Driven Tool' width={500} height={300} className='rounded-md mb-4' />
                    <h2 className='text-2xl font-bold'>Option 2: AI-Driven Tool</h2>
                    <p className='mt-2 text-gray-700'>Start your project with only a $20 upfront payment.</p>
                </div>
            </div>
            <div className='mt-10'>
